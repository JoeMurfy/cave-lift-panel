...
// from 5 different sections and some as follows:
...
const int ROCKER_SWITCH_UP_PIN = 2;
const int ROCKER_SWITCH_DOWN_PIN = 3;
const int LED_LEVEL_1_PIN = 6;
const int LED_LEVEL_2_PIN = 7;
const int LED_LEVEL_3_PIN = 8;
const int LED_LEVEL_4_PIN = 9;
...
// Variables to store the time of the last button state change
